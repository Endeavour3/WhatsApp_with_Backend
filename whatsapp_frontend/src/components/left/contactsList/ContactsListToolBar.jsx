        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        <CommunitiesIcon height={"24px"} width={"24px"} color="#aebac1" />
                    </IconButton>
                    <IconButton
                        id={"status"}
                        onClick={() => {
                    ...
                    >
                        <StatusIcon height={"24px"} width={"24px"} color="#aebac1" bgcolor="#009588" />
                    </IconButton>
                    <IconButton
                        id={"channels"}
                        onClick={() => {
                    ...
                    >
                        <ChannelsIcon height={"24px"} width={"24px"} color="#aebac1" />
                    </IconButton>
                    <IconButton
                        id={"newchat"}
                        onClick={() => {
                    ...
                    >
                        <NewChatIcon height={"24px"} width={"24px"} color="#aebac1" />
                    </IconButton>
                    <IconButton
                        id={"menu"}
                        onClick={(e) => {
