...
import { useSetProfileMutation } from "../../../store/contacts/contactApi";
...
export default function ProfileDrawer() {
  ...
  const personalInfo = useAppSelector((state) => state.contacts.contacts.find((contact) => contact.contactId === (id ? parseInt(id, 10) : undefined)))
