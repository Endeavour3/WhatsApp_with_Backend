                ...
                >
                    ...
                    <Input
                        ...
                        onKeyUp={(e) => {
                            if (e.key === "Enter") {
                                if (textToSend) {
                                    dispatch(generateMessage(textToSend, Number(id), contactId))
                                    setTextToSend("")
                                }
                            }
                        }}
...
function AttachmentModal({ anchor, isOpen, onClose }:{anchor:any, isOpen: boolean, onClose:any}) {
    ...
    return (
        ...
        >
            {attachmentOptions.map((option, index) => (
                ...
                >
                    <IconButton sx={{ margin: "0px 12px 0px 0px" }}>{option.icon}</IconButton>
                    <Typography
                        sx={{
                            color: '#d1d7db',
